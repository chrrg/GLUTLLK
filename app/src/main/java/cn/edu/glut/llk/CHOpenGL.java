...
//        GLES20.glEnable(GL10.GL_CULL_FACE);
        GLES20.glEnable(GL10.GL_DEPTH_TEST);//启用深度测试    
//        GLES20.glClearDepthf(1.0f);//设置深度缓存    
//        GLES20.glDepthFunc(GL10.GL_LEQUAL);//所做深度测试的类型  
...
//        Matrix.orthoM(mProjectionMatrix, 0, -ratio, ratio, -1, 1, 1, 10);//正交投影
//        Matrix.frustumM(mProjectionMatrix, 0, -ratio*0.4f, ratio*0.4f, -1*0.4f, 1*0.4f, 1, 50);
        Matrix.perspectiveM(mProjectionMatrix, 0, 45, ratio, 0.01f, 10f);
        Matrix.setLookAtM(mViewMatrix, 0,0, 0, 10f, 0, 0, 0f, 0f, 1f, 0.0f);
